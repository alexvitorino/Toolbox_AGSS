...
# ====================================================================
# Script de Automação - SERVIDOR 1 (TR = 0.1) — HÍBRIDO + LOG + CENÁRIOS
...
LOG_FILE="${LOG_DIR}/servidor1_$(date +%Y%m%d_%H%M%S).log"
trap 'echo "[SERVIDOR_1] Falha na linha $LINENO: \"$BASH_COMMAND\" (status $?)" | tee -a "$LOG_FILE"' ERR
...
CAPACITY=5
SERVER_ID="SERVIDOR_1"
MAX_PARALLEL_METHODS=1   # 1=serial | 2/3=parcial/total

# Saídas
OUTPUT_DIR="./output_servidor1"
RESULTS_DIR="./results_servidor1"
CSV_FILE="./results_servidor1_metrics.csv"
...
SUMMARY_FILE="./resumo_servidor1_hibrido_multiseed.txt"
{
  echo "======================================================================"
