...
# ====================================================================
# Script de Automação - SERVIDOR 2 (TR = 0.2) — HÍBRIDO + LOG + CENÁRIOS
...
LOG_FILE="${LOG_DIR}/servidor2_$(date +%Y%m%d_%H%M%S).log"
trap 'echo "[SERVIDOR_2] Falha na linha $LINENO: \"$BASH_COMMAND\" (status $?)" | tee -a "$LOG_FILE"' ERR
...
CAPACITY=5
SERVER_ID="SERVIDOR_2"
MAX_PARALLEL_METHODS=2   # 1=serial | 2/3=parcial/total

# Saídas
OUTPUT_DIR="./output_servidor2"
RESULTS_DIR="./results_servidor2"
CSV_FILE="./results_servidor2_metrics.csv"
...
SUMMARY_FILE="./resumo_servidor2_hibrido_multiseed.txt"
{
  echo "======================================================================"
